...
from PageObjects.SP_SAT_Heat_Chart import Sat_Heat_Chart
...
class Test_001_Login:
    ...
    def test_Catagory_series(self, setup):
        self.driver = setup
        self.b =Sat_Heat_Chart(self.driver)
    ...
    def test_que_records(self, setup):
        self.driver = setup
        self.b = Sat_Heat_Chart(self.driver)
    ...
    def test_Indi_records(self, setup):
        self.driver = setup
        self.b = Sat_Heat_Chart(self.driver)
